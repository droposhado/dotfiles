...
update-tmux-nord-theme:
	curl -sSL https://github.com/arcticicestudio/nord-tmux/archive/master.tar.gz \
		-o nord-tmux.tar.gz
...
update-xresources-nord-theme:
	curl -sSL https://github.com/arcticicestudio/nord-xresources/archive/master.tar.gz \
